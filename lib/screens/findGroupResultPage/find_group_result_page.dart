                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                          ...
                          child: Text(
                              "${"Members: " + data['members'].toString()}/10",
                              style: const TextStyle(color: Colors.white))),
                      Row(
                        ...
                        children: <Widget>[
                          TextButton(
                            ...
                            onPressed: () async {
                              //OBS: TEST FÖR ATT GÅ UR GRUPP - SKA INTE VARA HÄR
                              //OBS: TEST FÖR ATT GÅ UR GRUPP - SKA INTE VARA HÄR
                              //OBS: TEST FÖR ATT GÅ UR GRUPP - SKA INTE VARA HÄR
                              //OBS: TEST FÖR ATT GÅ UR GRUPP - SKA INTE VARA HÄR
                                      ...
                                      actions: [
                                        ...
                                        TextButton(
                                          onPressed: () async {
                                            ...
                                            var snapshotGroup =
                                                await _groupInUser.get();
                                            for (var doc
                                                in snapshotGroup.docs) {
                                              if (doc['name'] == _groupName) {
                                                doc.reference.delete();
                                              }
                                            }
                                          },
