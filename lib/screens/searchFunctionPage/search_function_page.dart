...
import 'package:firebase_core/firebase_core.dart';
  ...
  const List<String> listSubGenres = <String> [
    "1", "2", "3", "4", "5"
  ];

  const List<String> listDecades = <String> [
    "50s", "60s", "70s", "80s", "90s", "00s", "2010s", "2020s"
  ];

  const List<String> listStreamproviders = <String> [
    "Cmore", "HBO", "Netflix", "Hulu", "Viaplay"
  ];
...
class SearchFunctionPage extends StatefulWidget {
  ...
  @override
  _SearchFunctionPageState createState() => _SearchFunctionPageState();
}
